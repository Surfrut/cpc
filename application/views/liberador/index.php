			...
			<div class="row">
				<div class="col s12">
					<ul class="tabs colorCPC">
						<li class="tab colorCPC col s3"><a class="active" href="#test1">Individual</a></li>
						<li class="tab colorCPC col s3"><a href="#test2">Por Rango</a></li>
					</ul>
				</div>
				...
				<div id="test2" class="col s12">desde - hastas (diseñando)</div>
			</div>
